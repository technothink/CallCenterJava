...
public class Segments {
	...
	public SpeakerItems[] getItems() {
		return items;
	}

	public void setItems(SpeakerItems[] items) {
		this.items = items;
	}
	...
	public String toString() {
		return "ClassPojo [items = " + items + ", end_time = " + end_time + ", speaker_label = " + speaker_label
